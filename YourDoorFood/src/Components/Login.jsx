...
export default function Login() {
  ...
  const submitForLogin = async () => {
    ...
    // console.log(data);
    const response = await loginCustomer('http://localhost:8888/api/YourDoorFood/login/customer/login', data)
  ...
  return (
    <>
      <div className="container">
        ...
        <form onSubmit={submitForLogin} action="" className="form">
          <input required className="input" type="number" name="mobileNumber" id="mobileNumber" placeholder="Mobile Number" value={mobileNumber} onChange={(e) => setMobileNumber(e.target.value)} />
        ...
        <div className="social-account-container">
          <span className="title">Create a account <NavLink to="/loginSignUp/signUp">SignUP</NavLink></span>
